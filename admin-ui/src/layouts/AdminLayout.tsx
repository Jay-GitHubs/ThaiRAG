...
const baseMenuItems = [
  ...
  { key: '/knowledge-graph', icon: <NodeIndexOutlined />, label: 'Knowledge Graph', minRole: 'editor' as UserRole },
  ...
  { key: '/ab-tests', icon: <SplitCellsOutlined />, label: 'A/B Testing', minRole: 'super_admin' as UserRole },
  { key: '/backup', icon: <CloudDownloadOutlined />, label: 'Backup & Restore', minRole: 'super_admin' as UserRole },
