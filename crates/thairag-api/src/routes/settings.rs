...
fn config_to_response(p: &thairag_config::schema::ProvidersConfig) -> ProviderConfigResponse {
    ...
    ProviderConfigResponse {
        ...
        reranker: RerankerProviderInfo {
            ...
            normalize_scores: p.reranker.normalize_scores,
        },
...
pub struct ChatPipelineConfigResponse {
    ...
    // Follow-up turns with replayed attachments: retrieval on/off
...
pub struct UpdateChatPipelineRequest {
    ...
    pub attachment_follow_up_retrieval: Option<bool>,
    // Agentic doc-selection
    ...
    F: Fn(&str) -> Option<String>,
{
    thairag_config::schema::ChatPipelineConfig {
        ...
        attachment_follow_up_retrieval: s("chat_pipeline.attachment_follow_up_retrieval")
            .and_then(|v| v.parse().ok())
            .unwrap_or(cp.attachment_follow_up_retrieval),
...
fn build_chat_pipeline_response_from_config(
    ...
    ChatPipelineConfigResponse {
        ...
        attachment_follow_up_retrieval: eff.attachment_follow_up_retrieval,
...
pub async fn update_chat_pipeline_config(
    ...
    persist_bool!(
        ...
        "chat_pipeline.attachment_follow_up_retrieval"
    );
    // Agentic doc-selection
